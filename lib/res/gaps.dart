...
class Gaps {
  ...
  static Widget divider10 = Container(
      decoration: BoxDecoration(color: Colours.color_FFF7F7F7), height: 10);
  static Widget divider20= Container(
      decoration: BoxDecoration(color: Colours.color_FFF7F7F7), height: 20);
