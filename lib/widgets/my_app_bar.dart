...
import 'package:saas_flutter_module/util/theme_utils.dart';
...
class MyAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const MyAppBar({
    ...
    this.centerTitle = '',
    this.actionName = '',
    this.backImg = 'assets/images/ic_back.png',
    this.backImgColor,
    this.onPressed,
    this.isBack = true
  });
    ...
    final Widget action = actionName.isNotEmpty ? Positioned(
      ...
      child: Theme(
        ...
        child: MyButton(
          ...
          minWidth: null,
          text: actionName,
          textColor: context.isDark ? Colours.dark_text : Colours.color_FF333333,
